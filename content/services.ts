    ...
    benefits: [
      {
        ...
        icon: ClipboardCheck,
        visual: { kind: "record", title: "Packing spec", lines: ["Box type", "Inserts", "Labelling"] },
      },
      {
        ...
        icon: Layers,
        visual: { kind: "hub", spokes: ["Storage", "Picking", "Dispatch"], hub: "One partner" },
      },
      {
        ...
        icon: BoxesIcon,
        visual: { kind: "checks", items: [{ label: "Units received" }, { label: "Condition" }, { label: "Variances" }], result: "Counted in" },
      },
      {
    ...
    benefits: [
      {
        ...
        icon: Undo2,
        visual: { kind: "steps", steps: ["Return raised", "Collected", "Resolved"] },
      },
      {
        ...
        icon: ClipboardCheck,
        visual: { kind: "record", title: "Return record", lines: ["Condition", "Reason code", "Photographs"] },
      },
      {
        ...
        icon: RotateCcw,
        visual: { kind: "hub", spokes: ["Resell", "Repair", "Recycle"], hub: "Disposition" },
      },
      {
        ...
        icon: ShieldCheck,
        visual: { kind: "checks", items: [{ label: "Resellable" }, { label: "Repairable" }, { label: "Beyond repair", ok: false }], result: "Your rules" },
      },
    ],
    process: [
      {
    ...
    benefits: [
      {
        ...
        icon: ClipboardCheck,
        visual: { kind: "record", title: "Stock record", lines: ["Received", "On hand", "Dispatched"] },
      },
      {
        ...
        icon: ShieldCheck,
        visual: { kind: "hub", spokes: ["Palletised", "Shelved", "Small parts"], hub: "Your goods" },
      },
      {
        ...
        icon: Layers,
        visual: { kind: "steps", steps: ["Store", "Pick", "Dispatch"] },
      },
      {
        ...
        icon: Scale,
        visual: { kind: "levels", bars: [{ label: "Quiet", height: 40 }, { label: "Normal", height: 66 }, { label: "Peak", height: 94 }] },
      },
    ],
    process: [
      {
    ...
    benefits: [
      {
        ...
        icon: FileCheck2,
        visual: { kind: "checks", items: [{ label: "Commercial invoice" }, { label: "Packing list" }, { label: "Certificates" }], result: "Checked pre-departure" },
      },
      {
        ...
        icon: Plane,
        visual: { kind: "checks", items: [{ label: "Air freight" }, { label: "Ocean freight", ok: false }, { label: "Rail freight", ok: false }] },
      },
      {
        ...
        icon: ShieldCheck,
        visual: { kind: "hub", spokes: ["Broker", "Authorities", "Carrier"], hub: "Coordinated" },
      },
      {
        ...
        icon: Route,
        visual: { kind: "steps", steps: ["Airport", "Customs", "Your door"] },
      },
    ],
    process: [
      {
    ...
    benefits: [
      {
        ...
        icon: ShoppingBag,
        visual: { kind: "steps", steps: ["Retailer", "Our address", "You"] },
      },
      {
        ...
        icon: Layers,
        visual: { kind: "hub", spokes: ["Order one", "Order two", "Order three"], hub: "One parcel" },
      },
      {
        ...
        icon: ClipboardCheck,
        visual: { kind: "checks", items: [{ label: "Received" }, { label: "Condition" }, { label: "Contents" }], result: "Checked in" },
      },
      {
        ...
        icon: FileCheck2,
        visual: { kind: "record", title: "Export documents", lines: ["Invoice", "Declaration", "Declared value"] },
      },
    ],
    process: [
      {
